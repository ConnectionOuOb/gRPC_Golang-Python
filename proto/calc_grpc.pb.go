...
const (
	Calculator_Calculate_FullMethodName = "/myservice.Calculator/Calculate"
)
...
func (UnimplementedCalculatorServer) Calculate(context.Context, *CalcRequest) (*CalcResponse, error) {
...
var Calculator_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "myservice.Calculator",
